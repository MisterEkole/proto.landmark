...
#config='D:/Dev Projects/DeepStack/face-landmark/config/300w.yaml'
...
def image_output(image, name):
  ...
  print("Inference time: {:.2f} seconds".format(process_time))

  #writer.release()

  return outputs

''' runing inference on image'''

img=cv2.imread('D:/Dev Projects/DeepStack/proto.facelandmarkdetector/data/faces/299733036_fff5ea6f8e.jpg')
outputs=image_output(img,'D:/Dev Projects/DeepStack/proto.facelandmarkdetector/demo')
